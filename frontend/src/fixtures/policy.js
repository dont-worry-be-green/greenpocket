const cards = [
  ...
  },
  {
    ...
    detail: {
      ...
      marriage: '제한 없음',
      special:
        '2024.1.1. 이후 서울 전입 또는 서울 내 이사 후 전입신고를 마친 무주택 청년가구이며 거래금액 2억원 이하 전·월세 거주자',
  ...
  },
  {
    ...
    detail: {
      ...
      education: '제한 없음',
      marriage: '제한 없음',
      special: '만 19~34세, 연소득 5,000만원 이하인 무주택 청년',
      supervising: '국토교통부',
  ...
  },
  {
    ...
    detail: {
      ...
      marriage: '미혼',
      special:
        '무주택 저소득 청년(대학생·취업준비생 등)으로 소득·자산 기준 충족 필요',
  ...
  },
  {
    ...
    detail: {
      ...
      income: '공급유형별 전년도 도시근로자 월평균소득 기준 충족 필요',
      age: '만 19~39세',
      employment: '제한 없음',
      education: '제한 없음',
      marriage: '미혼',
      special:
        '만 19~39세 청년으로 무주택·자동차가액·자산 기준 충족 필요(청년형은 미혼)',
  ...
  },
  {
    ...
    detail: {
      ...
      marriage: '제한 없음',
      special:
        '청년안심주택 민간임대 입주(예정)자로서 청년 자산 2억 7,300만원 이하 등 세부 기준 충족 필요',
      supervising: '서울특별시 건축기획관',
      operating: '서울주택도시개발공사',
    },
  },
...
export function findPolicy(policyId) {
  ...
  return {
    ...
    conditions: {
      age: card.detail?.age ?? '만 19세~39세',
      income: card.detail?.income ?? '세부 소득 조건 확인',
      employment: card.detail?.employment ?? '세부 취업 상태 확인',
      education: card.detail?.education ?? '제한 없음',
      major: '제한 없음',
      marriage: card.detail?.marriage ?? '제한 없음',
